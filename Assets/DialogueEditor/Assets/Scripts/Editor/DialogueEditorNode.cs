...
namespace DialogueEditor
{
    ...
    public class UIOptionNode : UINode
    {
        ...
        {
            // Icon
            Rect icon = new Rect(rect.x + TEXT_BORDER * 0.5f, rect.y + TITLE_HEIGHT + TITLE_GAP, SPRITE_SZ, SPRITE_SZ);
            if (OptionNode.Icon != null)
                GUI.DrawTexture(icon, OptionNode.Icon.texture, ScaleMode.ScaleToFit);
